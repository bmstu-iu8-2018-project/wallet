...
void PasswordForWallet::save_authorization_data(const QString& path,
                                                const QString& name,
                                                const QString& pass) {
...
void PasswordForWallet::save_public_data(const QString& path,
                                         const OfflineWallet& wallet) {
...
void PasswordForWallet::save_wallet_data(const QString& name,
                                         const QString& pass) {
