...
InformationWindow::InformationWindow(QWidget* parent)
    : QWidget(parent), ui(new Ui::InformationWindow) {
  ui->setupUi(this);
...
void InformationWindow::on_boxRequests_currentIndexChanged(int index) {
  switch (index) {
    ...
    case (static_cast<int>(Requests::address_balance)): {
      ui->requestBrowser->clear();
      const auto balance_json_data =
          nu::get_address_balance(ui->address->text().toStdString());
    ...
    case (static_cast<int>(Requests::spent_transactions)): {
      ui->requestBrowser->clear();
      const auto spend_trans_json_data =
          nu::get_spent_transactions(ui->address->text().toStdString());
    ...
    case (static_cast<int>(Requests::unspent_transactions)): {
      ...
      const auto unspend_trans_json_data =
          nu::get_unspent_transactions(ui->address->text().toStdString());
    ...
    case (static_cast<int>(Requests::received_transactions)): {
      ui->requestBrowser->clear();
      const auto received_trans_json_data =
          nu::get_received_transactions(ui->address->text().toStdString());
